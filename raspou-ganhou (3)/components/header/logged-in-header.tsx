  ...
  return (
    <div className="flex items-center gap-4">
      ...
      <Button
        ...
        className="text-white hover:text-gray-300 hover:bg-white/10 transition-all duration-300 hover:scale-110 active:scale-95 relative"
      >
        <ShoppingCart className="w-5 h-5" />
        {/* Badge de quantidade - TODO: integrar com estado real do carrinho */}
